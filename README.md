...
| [`improvements/`](improvements) | Kredo v2 design extensions (implemented, in Russian): retention channel, cooperative form, Sybil defense, dynamic lock-up, drift detector — plus an end-to-end fraud adversary (Phase 6) |
