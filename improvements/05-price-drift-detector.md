...
Не реализовано. Дешёвый механизм (два числа на категорию + одна проверка),
закрывает последний названный в Limitations стратегический канал. Делать
в связке с 04 (общая инфраструктура флагов/эскалации).
